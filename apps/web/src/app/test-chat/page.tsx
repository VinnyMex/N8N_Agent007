...
export default function TestChatPage() {
  ...
  async function runTests() {
    ...
    try {
      ...
      setTestResults({ summary: "Failed to run tests", totalTime: "0ms", ready: false, tests: {} });
    } finally {
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <aside className="hidden w-80 shrink-0 border-r border-border bg-card md:flex md:flex-col">
        <div className="flex items-center gap-2 border-b border-border px-6 py-5">
          ...
          <span className="text-lg font-bold">Test Mode</span>
        </div>
        ...
        <div ref={scrollRef} className="flex-1 overflow-auto p-6 space-y-6">
          {messages.length === 0 && (
            <div className="flex h-full flex-col items-center justify-center text-center">
              ...
              <h2 className="text-xl font-semibold">Agent007 Test Mode</h2>
              <p className="mt-2 max-w-md text-muted-foreground">
                This is a standalone test using mock n8n data.
                The AI agent (Claude) will use tool calling to interact with simulated workflows.
              </p>
              <p className="mt-4 text-sm text-muted-foreground">
                Try: &quot;List my workflows&quot; or &quot;Show failed executions&quot;
              </p>
            </div>
          )}
        ...
        <div className="border-t border-border p-4">
          <form onSubmit={handleSubmit} className="flex gap-3">
            <input
              ...
              placeholder="Ask about your n8n workflows (mock data)..."
