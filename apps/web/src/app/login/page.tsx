  ...
  async function handleEmailLogin(e: React.FormEvent) {
    ...
    if (mode === "login") {
      ...
      if (error) {
        ...
        setMessage("Check your email to confirm your account, or just sign in if email confirmation is disabled.");
        setLoading(false);
      }
    }
  }
    ...
    <div className="flex min-h-screen items-center justify-center bg-background">
      <div className="w-full max-w-md space-y-6 rounded-2xl border border-border bg-card p-10">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold">Welcome to Agent007</h1>
          <p className="mt-2 text-muted-foreground">
            Sign in to manage your n8n with AI
          </p>
        </div>
